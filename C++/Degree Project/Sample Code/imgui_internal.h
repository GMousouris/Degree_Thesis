...
namespace ImGui
{
	...
	IMGUI_API bool          TabItemEx2(ImGuiTabBar* tab_bar, const char* label, const char* t_label, bool* p_open, ImGuiTabItemFlags flags);
	...
	IMGUI_API void          RenderMyText(ImVec2 pos, const char* text, const char* text_end = NULL, float scale = 1.0f, bool hide_text_after_hash = true);
	...
	IMGUI_API void          RenderMy_Arrow(ImVec2 pos, ImGuiDir dir, ImVec4 color, float scale = 1.0f);

	IMGUI_API void          RenderMyArrow(ImVec2 pos, ImGuiDir dir, float scale = 1.0f);
	IMGUI_API void          RenderBullet(ImVec2 pos);
	IMGUI_API void          RenderMyBullet(ImVec2 pos);
	...
	IMGUI_API bool          My_ArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags);
	...
	IMGUI_API bool          MyTreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end = NULL, bool is_visible = true);
	IMGUI_API bool          MyTreeNodeBehavior_2(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end = NULL, float width = 1.0f);
